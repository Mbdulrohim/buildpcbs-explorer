      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col">
            <span className="text-base font-bold tracking-tight text-white leading-none font-mono">BuildPCBs</span>
            <span className="text-[10px] text-zinc-500 font-mono uppercase tracking-widest group-hover:text-pcb-primary-light transition-colors">Explorer_V1</span>
          </div>
        </Link>
        ...
        <div className="hidden md:flex items-center flex-1 max-w-lg mx-8 relative group">
          <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
             ...
             <span className="ml-2 text-zinc-600 font-mono text-xs group-focus-within:text-pcb-primary-light transition-colors">{'>'}</span>
          </div>
          <input 
            type="text" 
          ...
          <div className="absolute right-3 flex items-center pointer-events-none">
            <span className="text-[10px] text-zinc-600 border border-zinc-800 px-1.5 rounded bg-black">CMD+K</span>
          </div>
        </div>

        {/* Actions */}
        <div className="flex items-center gap-6">
          <a href="#" className="hidden sm:block text-zinc-400 hover:text-white text-xs font-mono uppercase tracking-wide transition-colors">
            Docs
          </a>

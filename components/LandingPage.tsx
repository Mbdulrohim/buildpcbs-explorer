        ...
        <section id="marketplace" className="py-24 border-t border-zinc-900">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
              ...
              <button className="px-6 py-2 border border-zinc-700 rounded-full text-sm font-medium hover:bg-zinc-800 transition-colors font-sans uppercase tracking-wider">
                Browse All Modules
              </button>
            </div>
            <MarketplacePreview />
        ...
        <section className="py-32 bg-gradient-to-b from-black to-blue-950/20">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <button className="w-full sm:w-auto px-12 py-5 bg-[#0038df] hover:bg-blue-700 text-white rounded-full font-bold text-lg transition-all shadow-lg shadow-blue-900/20 uppercase tracking-widest">
                Get Started
              </button>

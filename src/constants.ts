...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    description:
      "A robust industrial IoT gateway featuring the ESP32-S3 w/ Wi-Fi 6 & Bluetooth LE. Includes RS485 interface and 24V DC input protection.",
  ...
  },
  {
    ...
    description:
      "60% split mechanical keyboard PCB with hot-swap sockets and QMK/VIA support. Features per-key RGB and USB-C interconnect.",
    ...
    bom: [
      ...
      {
        partNumber: "Kailh-Hot-Swap",
        description: "Hot Swap Socket",
        quantity: 64,
        manufacturer: "Kailh",
      },
    ],
  ...
  },
  {
    ...
    description:
      "High-efficiency MPPT solar charger for single-cell LiPo batteries. Perfect for remote sensor nodes. Ultra-low quiescent current.",
    ...
    bom: [
      {
        partNumber: "SPV1040",
        description: "Solar Boost Converter",
        quantity: 1,
        manufacturer: "STMicro",
      },
      {
        partNumber: "Inductor 10uH",
  ...
  },
  {
    ...
    description:
      "Zero-latency HDMI video scaler based on Artix-7 FPGA. Open source bitstream available via IPFS.",
